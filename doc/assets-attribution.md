The following is a list of assets used in the mpaycoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://mpaycointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original mpaycoin logo from Bitboy)
* License: MIT
