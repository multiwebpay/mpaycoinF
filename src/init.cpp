...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: mpaycoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: mpaycoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 7817 or testnet: 17817)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 7818 or testnet: 17818)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the Mpaycoin Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Mpaycoin process is using the data directory.
